...
class clustering_metrics():
    ...
    def clusteringAcc(self):
        ...
        purity = self.purity_score(self.true_label, new_predict)
        return acc, f1_macro, precision_macro, recall_macro, f1_micro, precision_micro, recall_micro, purity

    def purity_score(self,true_label, new_predict):
        # compute contingency matrix (also called confusion matrix)
        contingency_matrix = metrics.cluster.contingency_matrix(true_label, new_predict)
        # return purity
